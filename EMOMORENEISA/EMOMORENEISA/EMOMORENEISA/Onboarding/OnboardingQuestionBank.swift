...
enum OnboardingQuestionBank {
    ...
    static func bundleAudioURL(for slot: OnboardingSlot,
        ...
        // Assets/{lang}/{gender}/{slot}.aac
        let subdir = "Onboarding/Assets/\(langFolder)/\(genderFolder)"
        return Bundle.main.url(forResource: slot.rawValue, withExtension: "aac", subdirectory: subdir)
    }
    ...
    private static let ukHe: [OnboardingSlot: String] = [
        ...
        .q5:  "Як ти оцінюєш свою іспанську зараз — окремо розуміння, граматику і говоріння, кожне саме по собі?",
