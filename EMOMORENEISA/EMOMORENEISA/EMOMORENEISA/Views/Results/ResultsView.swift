...
struct ResultsView: View {
    ...
    private var scoreHeader: some View {
        VStack(spacing: 12) {
            ...
            Text(isPerfect ? "PERFECT ROUND!" : "ROUND COMPLETE")
            ...
            Text(isPerfect ? "¡Excelente! All conjugations correct" : "\(total - correct) to review")
        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            ForEach(cells) { cell in
                HStack(spacing: 12) {
                    ...
                    HStack(spacing: 5) {
                        Image(systemName: title == "CORRECT" ? "checkmark" : "xmark")
